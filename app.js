...
function OWIDAnalytics() {
    ...
    const generateChartTitle = (query, xCol, yCol) => {
    ...
    const analyzeDataForChart = (data, columns, query) => {
        ...
        const title = generateChartTitle(query, xCol, yCol);
...
fig = px.line(df, x='${queryResult.columns[0]}', y='${queryResult.columns[1] || queryResult.columns[0]}')
fig.show()
`;
                    ...
                    <>
                        <div className="bg-white rounded-lg shadow-lg p-6 mb-6">
                            ...
                            <button
                                ...
                                disabled={loading}
                                className="mt-4 px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 disabled:bg-gray-400 font-semibold"
                            >
                                ...
                                <div className="bg-white rounded-lg shadow-lg p-6 mb-6">
                                    <div className="flex justify-between items-center mb-4">
                                        ...
                                        <div className="flex gap-2">
                                            <button onClick={exportPNG} className="px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700">
                                                📊 PNG
                                            </button>
                                            <button onClick={exportSVG} className="px-4 py-2 bg-purple-600 text-white rounded-lg hover:bg-purple-700">
                                                📄 SVG
                                            </button>
                                            <button onClick={exportNotebook} className="px-4 py-2 bg-orange-600 text-white rounded-lg hover:bg-orange-700">
                                                💻 Code
                                            </button>
                                        </div>
                                    </div>
